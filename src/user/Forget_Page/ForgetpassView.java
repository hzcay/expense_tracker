...
public class ForgetpassView extends JPanel {
    ...
    public ForgetpassView() {
        ...
        JLabel heading = createLabel("Reset Password", ForgetPassConstants.HEADING_FONT,
                ...
                ForgetPassConstants.HEADING_X, ForgetPassConstants.HEADING_Y, ForgetPassConstants.HEADING_WIDTH,
                ForgetPassConstants.HEADING_HEIGHT);
        add(heading);

        JLabel usernameLabel = createLabel("Username", ForgetPassConstants.LABEL_FONT, ForgetPassConstants.LABEL_COLOR,
        ...
        JLabel passwordLabel = createLabel("Password", ForgetPassConstants.LABEL_FONT, ForgetPassConstants.LABEL_COLOR,
                ForgetPassConstants.PASSWORD_LABEL_X, ForgetPassConstants.PASSWORD_LABEL_Y,
                ForgetPassConstants.LABEL_WIDTH, ForgetPassConstants.LABEL_HEIGHT);
        add(passwordLabel);
        passwordEntry = createPasswordField(ForgetPassConstants.ENTRY_FONT, ForgetPassConstants.ENTRY_TEXT_COLOR,
                ForgetPassConstants.ENTRY_BACKGROUND_COLOR,
        ...
        JLabel password2Label = createLabel("Check Password", ForgetPassConstants.LABEL_FONT,
                ...
                ForgetPassConstants.LABEL_WIDTH, ForgetPassConstants.LABEL_HEIGHT);
        add(password2Label);
        password2Entry = createPasswordField(ForgetPassConstants.ENTRY_FONT, ForgetPassConstants.ENTRY_TEXT_COLOR,
                ForgetPassConstants.ENTRY_BACKGROUND_COLOR,
        ...
        submitButton = createButton("Submit", ForgetPassConstants.SUBMIT_BUTTON_FONT,
                ForgetPassConstants.SUBMIT_BUTTON_TEXT_COLOR, ForgetPassConstants.SUBMIT_BUTTON_BACKGROUND_COLOR,
        ...
        backButton = createButton("", ForgetPassConstants.BACK_BUTTON_FONT, ForgetPassConstants.BACK_BUTTON_COLOR,
                Color.WHITE,
